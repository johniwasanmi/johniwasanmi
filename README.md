# 👋 Hello, I'm John Iwasanmi (aka **PenDevOps**)

As a **penetration tester**, **developer**, my mantra is simple: **"Code safe, build strong."** I believe that security and development go hand-in-hand, and my goal is to ensure that applications and systems are not only robust but resilient against any threat. With expertise in **Web and Infrastructure pentesting**,  **secure code review (Python and Javascript)**. I thrive on creating security solutions that empower development teams.

---

## 👀 What I'm Interested In:
- **Infrastructure Security**: Specializing in enumerating, exploiting, and securing Active Directory environments, from privilege escalation to domain dominance.
...
- **Autonomous Penetration Testing with Deep Reinforcement Learning**: Exploring the use of Deep RL to automate penetration testing, focusing on adaptive attack strategies, intelligent vulnerability exploitation, and real-time decision-making in dynamic environments.
...
- **Web Application Security**:
  - In-depth experience conducting **source code reviews** for web applications to identify critical vulnerabilities like **SQL Injection**, **XSS**, **CSRF**, and more.
  - Knowledgeable in the OWASP Top 10  security risks, ensuring web applications meet security best practices.
